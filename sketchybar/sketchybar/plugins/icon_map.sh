case "$1" in
  ...
  "Affinity Publisher 2")
    ...
    ;;
  "Calendar" | "BusyCal" | "Fantastical" | "Cron" | "Amie")
  ...
  "Affinity Designer 2")
    ...
    ;;
  "Keyboard Maestro" | "Keyboard Cowboy")
  ...
  "zoom.us")
    icon_result=":zoom:"
    ;;
  "Affinity Photo 2" | "Pixelmator Pro")
  ...
  "Warp")
    icon_result=":warp:"
    ;;
  "System Preferences" | "System Settings" | "Systemeinstellungen" | "System.*einstellungen")
    icon_result=":gear:"
    ;;
  "Affinity Designer")
