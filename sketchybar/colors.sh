...
export DARK_GREY=0x38292d3e
export GREY_50=0x80676e95 #676e95
export LIGHT_GREY=0x23a6accd #a6accd
export LIGHT_BLACK=0x8a262323
...
# General bar colors
export BAR_COLOR=0x6624273a  #0x6624273a
export ICON_COLOR=$DARK_WHITE # Color of all icons
export LABEL_COLOR=$DARK_WHITE # Color of all labels
export BACKGROUND_1=$BG2
